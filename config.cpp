...
class CfgExileCustomCode 
{
	...
	*/
    ...
    ExileClient_util_gear_getCompatibleWeaponItems = "Custom\ASDG-JR\ExileClient_util_gear_getCompatibleWeaponItems.sqf";
    ExileClient_util_item_getCompatibleWeaponItems = "Custom\ASDG-JR\ExileClient_util_item_getCompatibleWeaponItems.sqf";
...
class CfgInteractionMenus
{
	class Car 
	{
		...
		class Actions 
		{
			...
			// Pakowanie/Rozpakowywanie pojazdu
...
{
	class Exile_Container_Safe_Small { max = 1000000; };	
};
class CfgSimulation
{
	/*
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{10000,					30,			60 					}, // Level 2 
		{20000,					45,			90 					}, // Level 3
		{35000,					60,			120					}, // Level 4
		{50000,					75,			150					}, // Level 5
		{75000,					90,			180					}, // Level 6
		{100000,					105,		210					}, // Level 7
		{125000,					120,		240					}, // Level 8
		{150000,					135,		270					}, // Level 9
		{200000,					150,		300					}  // Level 10
	};
